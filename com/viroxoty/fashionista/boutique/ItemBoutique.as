...
//com.viroxoty.fashionista.boutique.ItemBoutique
...
package com.viroxoty.fashionista.boutique{
    ...
    public class ItemBoutique extends AbstractBoutique {

        protected var boutique_model_mc:MovieClip;
        protected var boutique_model_controller:BoutiqueModel;
        protected var rows:int = 3;

        public function ItemBoutique(_arg1:BoutiqueDataObject){
            super(_arg1);
            Tracer.out(("new ItemBoutique: " + boutique_name));
            items_per_page = 18;
        }
        override public function get_catalog_data():void{
            DataManager.getInstance().get_items_xml(String(boutique.id), this, this.set_items_xml);
        }
        public function set_items_xml(_arg1:XML):void{
            Tracer.out(("ItemBoutique > set_items_xml : " + _arg1.toString()));
